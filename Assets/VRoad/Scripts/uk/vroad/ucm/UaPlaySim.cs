...
namespace uk.vroad.ucm
{
    public abstract class UaPlaySim : MonoBehaviour, LAppState, LSimTimeSec
    {
        ...
        {
#if UNITY_ANDROID
            KFile.SetMonoBehaviourInstance(this);
#endif
        ...
        public bool DeregisterFireMapChange() { return true; } // A new GameObject will be created for each map
        ...
        protected int fixedUpdatesPerTimeStep;
        ...
        protected virtual void FixedUpdate()
        {
            ...
            if (--fixedUpdateCountdown < 1)
            {
                ...
                if (prevStepFinished)
                {
                    ...
                    fixedUpdatesPerTimeStep = framesPerTimeStep / urti;
                    UaBotHandler.Instance.SetFixedUpdatesPerTimeStep(fixedUpdatesPerTimeStep);
